...
describe("ReservationContract tests", () => {
  var accounts, networkId, preSaleVesting, uac, uacUnsold, foundersVesting, ico, ubiatarPlay, advisorsWallet, reservationContract
  ...
  beforeEach("deploy ReservationContract", () => {
    return ReservationContract.new({from: owner})
  ...
  const ICODeploy = (uacAddress, uacUnsoldAddress, founderVestingAddress, preSaleVestingAddress, ubiatarPlayAddress, advisorsWallet) => {
    return ICO.new(uacAddress, uacUnsoldAddress, founderVestingAddress, preSaleVestingAddress, ubiatarPlayAddress, advisorsWallet, {from: owner})
      ...
      .then(() => reservationContract.setUacTokenAddress(uacAddress, {from: owner}))
